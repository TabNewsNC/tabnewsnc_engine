...
class NewsEntityMapper extends ClassMapperBase<NewsEntity> {
  ...
  static const Field<NewsEntity, String> _f$ownerId = Field(
    'ownerId',
    _$ownerId,
    key: r'owner_id',
  );
  ...
  static const Field<NewsEntity, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  static DateTime _$updatedAt(NewsEntity v) => v.updatedAt;
  static const Field<NewsEntity, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    key: r'updated_at',
  );
  static DateTime _$publishedAt(NewsEntity v) => v.publishedAt;
  static const Field<NewsEntity, DateTime> _f$publishedAt = Field(
    'publishedAt',
    _$publishedAt,
    key: r'published_at',
  );
  static int _$tabcoins(NewsEntity v) => v.tabcoins;
  static const Field<NewsEntity, int> _f$tabcoins = Field(
    'tabcoins',
    _$tabcoins,
  );
  static int _$tabcoinsDebit(NewsEntity v) => v.tabcoinsDebit;
  static const Field<NewsEntity, int> _f$tabcoinsDebit = Field(
    'tabcoinsDebit',
    _$tabcoinsDebit,
    key: r'tabcoins_debit',
  );
  static int _$tabcoinsCredit(NewsEntity v) => v.tabcoinsCredit;
  static const Field<NewsEntity, int> _f$tabcoinsCredit = Field(
    'tabcoinsCredit',
    _$tabcoinsCredit,
    key: r'tabcoins_credit',
  );
  static String _$ownerUsername(NewsEntity v) => v.ownerUsername;
  static const Field<NewsEntity, String> _f$ownerUsername = Field(
    'ownerUsername',
    _$ownerUsername,
    key: r'owner_username',
  );
  static int _$commentCount(NewsEntity v) => v.commentCount;
  static const Field<NewsEntity, int> _f$commentCount = Field(
    'commentCount',
    _$commentCount,
    key: r'children_deep_count',
  );
  static List<NewsEntity> _$children(NewsEntity v) => v.children;
  static const Field<NewsEntity, List<NewsEntity>> _f$children = Field(
    'children',
    _$children,
    hook: NullToListHook(),
  );
  static String? _$title(NewsEntity v) => v.title;
  static const Field<NewsEntity, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static String? _$body(NewsEntity v) => v.body;
  static const Field<NewsEntity, String> _f$body = Field(
    'body',
    _$body,
    opt: true,
  );
...
mixin NewsEntityMappable {
  String toJson() {
    return NewsEntityMapper.ensureInitialized().encodeJson<NewsEntity>(
      this as NewsEntity,
    );
  }

  Map<String, dynamic> toMap() {
    return NewsEntityMapper.ensureInitialized().encodeMap<NewsEntity>(
      this as NewsEntity,
    );
  }

  NewsEntityCopyWith<NewsEntity, NewsEntity, NewsEntity> get copyWith =>
      _NewsEntityCopyWithImpl<NewsEntity, NewsEntity>(
        this as NewsEntity,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return NewsEntityMapper.ensureInitialized().stringifyValue(
      this as NewsEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return NewsEntityMapper.ensureInitialized().equalsValue(
      this as NewsEntity,
      other,
    );
  }
...
extension NewsEntityValueCopy<$R, $Out>
  ...
  NewsEntityCopyWith<$R, NewsEntity, $Out> get $asNewsEntity =>
      $base.as((v, t, t2) => _NewsEntityCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _NewsEntityCopyWithImpl<$R, $Out>
  ...
  NewsEntityCopyWith<$R2, NewsEntity, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _NewsEntityCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
